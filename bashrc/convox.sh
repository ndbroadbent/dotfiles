...
alias  cxu="rack-gateway switch us"
alias  cxe="rack-gateway switch eu"
alias  cxa="rack-gateway switch au"
# alias cxs="convox switch staging"
# alias cxp="convox switch us"
# alias cxeu="convox switch eu"

alias  cxr="rack-gateway rack"
alias cxex="rack-gateway exec"
alias cxru="rack-gateway run"
alias  cxd="rack-gateway deploy --wait"
alias cxda="rack-gateway deploy-approval wait --approve --rack staging,us,eu,au"
alias cxds="rack-gateway deploy-approval wait --approve --rack staging"
